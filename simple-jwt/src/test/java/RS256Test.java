...
import io.shmilyhe.utils.encryption.RSSignature;

public class RS256Test {
    ...
    public static void main(String[] args){
        RSSignature rs = new RSSignature("RS256");
        String sgin = rs.sgin(getJwt(), getPri());
        System.out.println(sgin);
        System.out.println(sgin.equals(getSgin()));
        ...
        String p="13333333333@"+System.currentTimeMillis();
        String pen =null;
        try {
            pen=RSA.encryptByPrivateKey(p, RSA.getPrivateKey(getPri()));
             System.out.println("pen:"+pen);
             j.addPayload("jti", pen);
        } catch (Exception e) {
            e.printStackTrace();
        }
        String key="test";
        String js = j.toJwt(getPri());

        System.out.println(js);
        System.out.println(j);
        JWT j2 = new JWT();
        j2.fromJwt(js);
        System.out.println(j2.check(getPub()));
        System.out.println(j2.getPayload("jti"));
        try {
            String jti=(String) j2.getPayload("jti");
            pen=RSA.decryptByPublicKey(jti, RSA.getPublicKey(getPub()));
